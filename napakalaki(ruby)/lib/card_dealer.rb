...
require_relative 'specific_visible_and_numeric_hidden_bad_consequence'
...
bc = SpecificBadConsequence.new('Pierdes tu armadura visible y otra oculta',
                                                          ...
                                                          [TreasureKind::ARMOR],
                                                          [TreasureKind::ARMOR])
@unusedMonsters.push(Monster.newmonster('3 Byakhess de bonanza', 8, bc, price, 0))
...
bc = SpecificBadConsequence.new('Embobados con el lindo primigenio te descartas de tu casco visible',
                                                          ...
                                                          [TreasureKind::HELMET], 
                                                          Array.new)
@unusedMonsters.push(Monster.newmonster('Chibithulhu', 2, bc,price, 0))
...
@unusedMonsters.push(Monster.newmonster('El sopor de Dunwich', 2, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('Ángeles de la noche ibicenca', 14, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('El gorrón en el umbral', 10, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('H.P. Munchcraft', 6, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('Bichgooth',2, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('El rey de la rosa',13,bc,price, 0))
...
@unusedMonsters.push(Monster.newmonster('La que redacta en las tinieblas', 2, bc, price, 0))
...
bc = DeathBadConsequence.new('Estos monstruos resultan bastante superficiales y te aburren mortalmente.
                                Estas muerto', true)
@unusedMonsters.push(Monster.newmonster('Los hondos', 8, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('Semillas Cthulhu', 4, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('Dameargo', 1, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('Pollipólipo volante', 3, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('Yskhtihyssg-Goth', 12, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('Familia feliz', 1, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('Roboggoth', 8, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('El espia', 5, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('El Lenguas', 20, bc, price, 0))
...
@unusedMonsters.push(Monster.newmonster('Bicéfalo', 20, bc, price, 0))
...
price = Prize.new(1,2)
bc=SpecificVisibleAndNumericHiddenBadConsequence.new('Pierdes 2 tesoros ocultos y una armadura visible', 0, 2, [TreasureKind::ARMOR])
@unusedMonsters.push(Monster.newmonster('Sadd', 7, bc, price, 0))

price = Prize.new(2,1)
bc=SpecificVisibleAndNumericHiddenBadConsequence.new('Pierdes todos los tesoros ocultos mas un calzado y una mano visibles', 0, BadConsequence.getMaxTreasures, [TreasureKind::SHOES, TreasureKind::ONEHAND])
@unusedMonsters.push(Monster.newmonster('Tutan', 12, bc, price, 0))

price = Prize.new(1,2)
bc=SpecificVisibleAndNumericHiddenBadConsequence.new('Pierdes 1 tesoro oculto y un casco visible', 0, 1, [TreasureKind::HELMET])
@unusedMonsters.push(Monster.newmonster('Cooky', 2, bc, price, 0))
end
  ...
  def nextCultist
    aux=@unusedCultists.first
    @unusedCultists.delete(aux)
    return aux;
  end
